...
class sniff_tk(Tkinter.Tk):
    ...
    def initialize(self):
        ...
        button = Tkinter.Button(self,text=u"Initialize Base")
        button.grid(column=0,row=0)

        button = Tkinter.Button(self,text=u"Start Poll")
        button.grid(column=0,row=1)

        button = Tkinter.Button(self,text=u"End Poll")
